...
const a = {
  local: {
    ...
    POLICY_URL: 'https://apigateway-stage.tila.com/policy/api/v1',
  },
  dev: {
  ...
  preprod: {
    ...
    POLICY_URL: 'https://apigateway-preprod.tila.com/policy/api/v1',
  },
  prod: {
    ...
    POLICY_URL: 'https://apigateway.tila.com/policy/api/v1',
  },
  production: {
    IMAGE_SEARCH_URL: 'https://apigateway.tila.com/image-search',
    SEARCH_API_URL: 'https://apigateway.tila.com/search',
