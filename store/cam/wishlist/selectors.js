    ...
    if (data && data.length > 0) {
      data.forEach((item) => {
        ...
        newData.push({
          ...
          cur: pricing.offer_price && pricing.offer_price.currency_code,
          price: pricing.offer_price && pricing.offer_price.display_value,
          mrp: pricing.mrp && pricing.mrp.display_value,
          ...
          changed_percentage: item.changed_percentage,
