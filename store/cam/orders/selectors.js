  ...
  if (orders && orders.length) {
    return orders.map((order) => {
      ...
      return {
        ...
        orderTotal: `${total_amount.display_currency_code} ${total_amount.display_value}`,
        orderCurrency: `${total_amount.display_currency_code}`,
        orderAmount: `${total_amount.display_value}`,
        totalOrderPrice: price,
        shippingCharges: `${total_shipping.display_currency_code} ${total_shipping.display_value}`,
        orderItems,
        order_type,
        payments,
