var responsivelyLazy =
	"undefined" !== typeof responsivelyLazy
		? responsivelyLazy
		: (function() {
				var r = !1,
					t = !1,
					...
					w = function(a, b) {
						for (var c = a.length, d = b; d < c; d++) {
							...
							null !== g &&
								...
								// 	"url('https://k.nooncdn.com/nr/misc/product-image-default.jpg')") &&
								// 	(e.style.backgroundPosition = "center") &&
								(e.style.height = 0) &&
									("undefined" === typeof f.async || !1 === f.async) &&
									d + 1 < c &&
									((h = !0),
					...
					x = function(a, b) {
						...
						"undefined" === typeof a.responsivelyLazyLastSetOption &&
							(a.responsivelyLazyLastSetOption = ["", 0]);
						a.responsivelyLazyLastSetOption[1] < d[1] &&
							((a.responsivelyLazyLastSetOption = d),
							(h = d[0]),
							"undefined" === typeof a.responsivelyLazyEventsAttached &&
								((a.responsivelyLazyEventsAttached = !0),
								b.addEventListener(
									"load",
									function() {
							...
							null !== b
								...
								: t &&
								  ("img" === a.tagName.toLowerCase()
										? x(a, a)
										: ((b = a.querySelector("img")), null !== b && x(a, b)));
						}
					},
					z = function() {
						for (
							var a = document.querySelectorAll(".responsively-lazy"),
								b = a.length,
								c = 0;
							c < b;
							c++
						...
						if (m) {
							var d = function() {
								for (
									...
									var e = a[c];
									"undefined" === typeof e.responsivelyLazyObserverAttached &&
										((e.responsivelyLazyObserverAttached = !0), h.observe(e));
								}
							};
							...
							g = function() {
								for (
									...
									for (
										...
										d && "html" !== d.tagName.toLowerCase();

									)
										"undefined" === typeof d.responsivelyLazyScrollAttached &&
											((d.responsivelyLazyScrollAttached = !0),
