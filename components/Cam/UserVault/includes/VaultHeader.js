      ...
      <Row>
          ...
          <div className={`${styles['flex']} ${styles['flex-center']} ${styles['p-15']}`}>
            ...
            <div className={`${styles['tila-credit-wrap']} ${styles['flex']} ${styles['align-center']}`}>
              ...
              <div className={styles['amount-wrap']}>
                <div className={`${styles['currency']} ${styles['fs-12']}`}>{VAULT_PAGE.CREDIT}</div>
        ...
        <Col md={12}>
          ...
          <Tabs defaultActiveKey={1} className={`${styles['card-items-list']} ${styles['mb-0']} ${styles['pl-30']}`} id="vault-section">
            ...
            <Tab eventKey={2} title={`${VAULT_PAGE.TILA_GIFT}`} className={`${styles['pointer']} ${styles['p-10']} ${styles['thick-gry-clr']}`}>
