...
const { LOGIN_PAGE, ORDER_PAGE, PAGE_NOT_FOUND } = languageDefinations();
        ...
        <div>
          ...
          <Row className={`${styles['pt-30']} ${styles.flex}`}>
            <Col md={5} xs={6} sm={6} className={`${styles.relative} ${styles.flex} ${styles['flex-colum']} ${styles['justify-center']} ${styles['pr-30']} ${styles['border-rt']}`}>
              ...
              <span className={`${styles.absolute} ${styles['bg-white']} ${styles.right0} ${styles['p-5']} ${styles['fs-10']} ${styles['border-lg']} ${styles['or-tag']}`} >{PAGE_NOT_FOUND.OR}</span>
            </Col>
