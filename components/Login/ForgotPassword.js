            ...
            <div className={styles['forgot-password']}>
                ...
                <div>
                    ...
                    <Col xs={12} md={12} className={`${styles['pt-30']}`}>
                        <Btn className={`${styles['fp-btn']} ${styles['fp-btn-primary']} ${styles['fp-btn-large']} ${styles['update-profile-btn']} ${styles['text-uppercase']}`} btnText='SEND VERIFICATION LINK' BtnClickHandler={this.sendLink} />
                    </Col>
                </div> 
                :
                <div>
