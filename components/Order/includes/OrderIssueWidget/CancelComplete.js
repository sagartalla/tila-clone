  ...
  render() {
    ...
    return (
              ...
              <div>
                ...
                <div className={`${styles['flex-center']} ${styles['justify-center']} ${styles['cancel-success-inn']}`}>
                  ...
                  <div className={`${styles['pt-20']} ${styles['t-c']} ${styles['cancel-success-label']}`}>
                    <span className={styles['fs-12']}>Your order <span className={styles['fontW600']}>{selectedItem.name}</span> has been Cancelled Successfully</span>
                  </div>
                </div>
                {/* <div>
                ...
                <div className={`${styles['mt-20']} ${styles['pt-10']} ${styles['pb-10']} ${styles['t-c']} ${styles['cancel-success-text']}`}>
                  <i className={styles['fs-12']}>Sorry that you had to cancel, we will work on reason for your cancellation</i>
                </div>
              </div>
            }
          </div>
      ...
      <div className={`${styles['widget-footer']} ${styles['flex-center']} ${styles['justify-center']} ${styles['box']} ${styles['pt-24']}`}>
        <button onClick={goToNextStep} className={`${styles['fp-btn']} ${styles['fp-btn-primary']}`} disabled={loadingStatus}>Done</button>
      </div>
      </div>
    );
  }
