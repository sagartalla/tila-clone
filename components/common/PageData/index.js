...
class PageData extends React.Component {
  ...
  getContent = () => {
    ...
    switch (content.layout_id) {
      case 'CT1a': return <CT1a content={content} />;

      case 'CT1': return <CT1 content={content} />;

      case 'CBT6a': return <CBT6a content={content} index={`${content.layout_id}${index}`} />;

      case 'CBT6b': return <CBT6b content={content} index={`${content.layout_id}${index}`} />;

      case 'DT1': return <DT content={content} index={`${content.layout_id}${index}`} />;
      ...
      case 'BT4':
      case 'BT6':
      case 'BT7': return <BT content={content} />;

      case 'CBT12': return <CBT12 content={content} index={`${content.layout_id}${index}`} />;

      case 'CBT12a': return <CBT12a content={content} index={`${content.layout_id}${index}`} />;

      case 'CBT5b': return <CBT5b content={content} />;

      case 'CBT6c': return <CBT6c content={content} />;

      case 'ST1a': return <ST1a content={content} />;

      case 'CBT2a': return <CBT2a content={content} />;

      case 'CBT3a': return <CBT3a content={content} />;

      case 'CBT8a': return <CBT8a content={content} />;

      case 'BT2a': return <BT2a content={content} index={`${content.layout_id}${index}`} />;

      case 'BT3a': return <BT3a content={content} index={`${content.layout_id}${index}`} />;

      case 'BT6a': return <BT6a content={content} index={`${content.layout_id}${index}`} />;
  ...
  returnBanner = (index, banners) => (
    <div
      className={`${styles['thick-gry-clr']} ${styles['fs-14']} ${styles['mt-10']} ${styles.pointer}`}
    >
