	...
	return (
		<div className={`${styles.fashionBannerSpacing}`}>
			<Slider
				...
				asNavFor={sliderFTBS}
				lazyLoad={false}
				className={`${styles.flex} ${styles["fashion-main-slider"]} ${
					styles["flex-colum"]
							...
							<a href={i.link}>
								...
								>
									<img
										src={i.img}
										alt={i.display_name}
										className={`${styles.width100} ${styles.imageRounded}`}
									/>
								</div>
							</a>
							<span
								className={`${styles["fs-12"]} ${styles["pt-10"]} ${
									styles["justify-center"]
								} ${styles["slider-elips"]} ${styles["lne-ht1_2"]}`}
