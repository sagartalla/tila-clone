    ...
    render(){
        ...
        return(<div>
              <div className={`${styles['display-t-i-cb']} ${styles.flex}`} >
                ...
                <div className={`${styles['p-0-5']} ${styles.flex}`} style={{ width: '33.7%' }}>
                ...
                <div className={`${styles['p-0-5']}`} style={{ width: '16.8%' }}>
                ...
                <div style={{ width: '16.8%' }} className={`${styles['p-0-5']}`}>
