...
const hal = [
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "Sports & Outdoor" : "الرياضات والخارج"
		}/clp`,
		key: "Sports & Outdoors"
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "Exercise & Fitness" : "تدريبات ولياقة"
		}/clp`,
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "Cushions & Covers" : "اغطية وسادات"
		}/clp`,
		key: "Cushions & Covers"
	},
	{
...
const tie = [
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "laptops" : "أجهزة-الكمبيوتر-المحمولة"
		}/clp`,
		key: "Laptops"
	},
	{
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "mobile-accessories" : "ملحقات-الهاتف-المحمول"
		}/clp`,
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "Tablet & iPads" : "اجهزة تابلت وايباد"
		}/clp`,
		key: "Tablets"
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "kitchen-appliances" : "أدوات-المطبخ"
		}/clp`,
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "Home Entertainment" : "أجهزة ترفيهية"
		}/clp`,
	...
	},
	{
		...
		link: `/${lang}/${
			lang === "en" ? "Computer Peripherals" : "ملحقات الكمبيوتر"
		}/clp`,
