    ...
    return (
      <div>
        ...
        <div className={`${styles['header-filter']} ${styles['flex-center']} ${styles['p-10-0']}`}>
          ...
          <div className={spellCheckResp ? `${styles['search-results']} ${styles['applied-filters-padding']} ${styles.width75} ${styles.relative}` : `${styles['search-results']} ${styles['applied-filters-padding']} ${styles.relative} ${spellCheckResp ? `${styles.width70}` : `${styles.width75}`}`}>
            <NoSSR>
              <AppliedFilters />
            </NoSSR>
          </div>
