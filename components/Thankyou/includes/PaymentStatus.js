...
const PaymentStatus = props => {
  ...
  const successMessage = "Your order has been placed and is being processed. You will receive an email with details once the item(s) are shipped. You can track your <a>Orders page</a> in your account";
