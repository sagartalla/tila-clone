...
const PaymentStatus = props => {
  ...
  const successMessage = <span>{THANK_YOU_PAGE.EMAIL_SHIPPMENT_DETAILS} {THANK_YOU_PAGE.TRACK_YOUR} {THANK_YOU_PAGE.ORDER} <a className={styles['fontW600']} href={`/${language}/customer/orders/${props.orderId}`}>{THANK_YOU_PAGE.HERE}</a>.</span>;
