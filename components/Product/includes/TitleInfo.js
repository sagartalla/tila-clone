  ...
  render() {
    ...
    return (
      <div className={styles['pb-10']}>
        ...
        <h1 className={`${styles['fs-18']} ${styles.fontW700} ${styles['black-color']} ${styles['mt-0']} ${styles['mb-0']} ${!title.translation ? styles['direction-i'] : ''}`}>{title.attribute_values[0].value}</h1>
        {
          isPreview
            ?
            null
