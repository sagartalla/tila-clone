  ...
  render() {
    ...
    return (
      <div className={styles['pb-10']}>
        ...
        <h1 className={`${styles['fs-18']} ${styles.fontW700} ${styles['black-color']} ${styles['mt-0']} ${styles['mb-0']} ${title && title.alignment ? styles['direction-ir'] : ''}`}>
          {title && title.attribute_values && title.attribute_values.length > 0
            && title.attribute_values[0].value}
        </h1>
        <h1 className={`${styles['fs-16']} ${styles.fontW300} ${styles['black-color']} ${styles['mt-5']} ${styles['mb-0']} ${title && title.alignment ? styles['direction-ir'] : ''}`}>
          {title && title.attribute_values && title.attribute_values.length > 1
