...
class ActionBar extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    let show = (!nextProps.isLoggedIn && (nextProps.isLoggedIn != this.props.isLoggedIn) && !this.state.logoutClicked) || this.state.loginClicked || !!nextProps.error || nextProps.loginInProgress || (!nextProps.isLoggedIn && nextProps.showLogin) || nextProps.showEmailScreen;
...
const mapStateToProps = (store) => {
  return ({
    ...
    showEmailScreen: selectors.showEmailScreen(store),
  })
};
