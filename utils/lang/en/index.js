export const EN_KEYWORDS = {
  CART_PAGE: {
    ...
    NO_PRODUCTS_IN_YOUR_FAVOURITES: 'no products in your favourites',
    MY_CART: 'My Cart',
    MY_CART_EMPTY: 'So many products on TiLa and yet, I feel empty :(', // doubt
  ...
  PAYMENT_PAGE: {
    ...
    USING_NEW_CARD: 'Using New Card', // content should modify in sheet
  ...
  WISH_LIST_PAGE: {
    ...
    WISHLIST_HEADER_ONE: 'item in wishlist', 
  ...
  HEADER_PAGE: {
    ...
    GO_TO_WISHLIST: 'Go to the wishlist',
    MORE_ITEM: 'more item',
  ...
  LOGIN_PAGE: {
    ...
    FACEBOOK: 'Facebook',
    GOOGLE: 'Google',
    FOR_SIGNING_UP_WITH_US: 'Thank you for signing up with us!',
    SIGNUP: 'SIGNUP',
