...
module.exports = (params) => {
  ...
  //   const sentryTransport = sentryTestkit().sentryTransport
  //
  ...
  //     // Trigger DevTools debugger insteaqd of using console.log
  //     debugger: false
  //   })]
  // }
  ...
  return {
    ...
    captureException: (err, options) => {
      const req = options.req, res = options.res, errorInfo = options.errorInfo, query = options.query, pathname = options.pathname;
