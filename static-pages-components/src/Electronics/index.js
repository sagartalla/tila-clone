  ...
  <div className="electronics-main-part">
    <Grid>
      ...
      <Row className={`${styles['m-0']} ${styles['pt-10']}`}>
        ...
        {/* top selling mobiles */}
        <div className={`top-selling-brands ${styles['pt-20']} ${styles['pb-20']}`}>
          <h4 className={`${styles['fontW600']}`}><span className={`populat-cat-title ${styles['bdr-btm-green-color']} ${styles['text-uppercase']}`}>Top Selling </span>  Mobiles</h4>
          <div className={`${styles['flex']} ${styles['pt-30']} ${styles['pb-30']}`}>
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling-mob.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
                  <span className={`${styles['fs-12']} ${styles['lgt-blue']}`}>Mi A1</span>
                  <SVGComponent clsName="wistlist-logo" src="icons/wish-list/wish-list-icon" />
                </span>
                ...
                <div className={styles['flex-center']}>
                  <span className={`rating ${styles['fs-10']} ${styles['white-color']}`}>4.5</span>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling-mob4.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling-mob1.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling-mob2.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling-mob3.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
        ...
        {/* top selling start */}
        <div className={`top-selling-brands ${styles['pt-30']} ${styles['pb-20']}`}>
          <h4 className={`${styles['fontW600']}`}><span className={`populat-cat-title ${styles['bdr-btm-green-color']} ${styles['text-uppercase']}`}>Top Selling </span> </h4>
          <div className={`${styles['flex']} ${styles['pt-30']} ${styles['pb-30']}`}>
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling1.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling2.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling3.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling4.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
            ...
            <Col md={2} className={styles['pl-0']}>
              <div className={`top-selling-img ${styles['flex-center']} ${styles['bg-white']} ${styles['p-35']}`}>
                <img src="/static/img/landing-page-tech-img/top-selling5.jpg" className="img-responsive" />
              </div>
              <div className={`top-price-details ${styles['flex']} ${styles['flex-colum']} ${styles['pt-15']}`}>
                <span className={styles['flx-spacebw-alignc']}>
